...
- Hello World on GCP Cloud Functions
...
In Google Cloud Platform (GCP), Cloud Functions and Cloud Run services automatically assume a Google-managed service account when deployed, usually known as service agents.
This service account must be granted the necessary permissions to access other GCP resources within your project if necessary.
...
- Access control with IAM for Cloud Run/Functions
- IAM roles and permissions for Cloud Functions
- IAM roles and permissions for Cloud Run
...
- API Gateways are mandatory: they centralize access, provide authentication, logging, monitoring, and protection.
