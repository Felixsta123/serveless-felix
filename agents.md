...
- Implemented: API Gateway template, deployment scripts, `discordProxy`, `webProxy`, `oauthProxy`, `workerDraw`, `workerDiscord`, `workerOAuth`, `workerSnapshot`.
...
- Remaining infra/docs gaps: monitoring alerts, TTL cleanup, DLQ/retry hardening, README + architecture diagram, prd project bootstrap.
