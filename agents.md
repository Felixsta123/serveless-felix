...
- Implemented: API Gateway template, deployment scripts, discordProxy, workerDiscord (hello), hello function.
- Stubs: webProxy, oauthProxy, workerDraw, workerSnapshot.
- No web app yet.
- No Firestore or GCS schema implemented yet.
